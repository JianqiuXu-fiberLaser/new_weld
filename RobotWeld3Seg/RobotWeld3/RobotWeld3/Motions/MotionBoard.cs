...
namespace RobotWeld3.Motions
{
    ...
    public class MotionBoard
    {
        ...
        private static int _pSegNo;

        public MotionBoard() { }

        /// <summary>
        /// Initialize the motion card.
        /// </summary>
        public virtual void InitialCard()
        {
            if (ConfigCard())
            {
                ConfigCoordinate();
                ConfigPort();
                MainModel.AddInfo("运动卡装载成功");
            }
        }
        ...
        /// </summary>
        /// <returns> false: initial fail. </returns>
        ...
        /// <summary>
        /// Configurate IO and DAC port.
        /// </summary>
        public static void ConfigPort()
        {
            // Setup wire driver DAC port
            NMC_SetDacMode(devHandle, (short)(MotionSpecification.WireDac - 1), 0);
            NMC_SetDac(devHandle, (short)(MotionSpecification.WireDac - 1), VOLT_BASE);
            SetBit(MotionSpecification.Withdraw, false);
            SetBit(MotionSpecification.FeedWire, false);

            // setup wobble driver DAC port
            NMC_SetDacMode(devHandle, (short)(MotionSpecification.WobbleDac - 1), 0);
            NMC_SetDac(devHandle, (short)(MotionSpecification.WobbleDac - 1), VOLT_BASE);
        }
        ...
        /// Reset X axis
        /// </summary>
        /// <returns> axis state code </returns>
        ...
        /// Reset A axis
        /// </summary>
        public virtual void ResetAaxis()
        {
            THomeSetting homeSetting = new()
            {
                mode = (short)THomeMode.HM_MODE1,
        ...
        /// <returns> 0: finished </returns>
        public static int FindOriginal(int iAxis)
        {
            THomeSetting homeSetting = new()
            {
                mode = (short)THomeMode.HM_MODE1,
        ...
        /// <summary>
        /// Check axis state in reset process.
        /// </summary>
        /// <param name="iAxis"> axis number </param>
        /// <returns> state error code </returns>
        ...
        /// </summary>
        /// <param name="iAxis"> axis number </param>
        /// <param name="acc"> accelerate coefficient </param>
        /// <param name="dcc"> deccelerate coefficient </param>
        /// <param name="smoothCoef"> smooth coefficient </param>
        ...
        /// </summary>
        /// <param name="iAxis"> axis number </param>
        /// <param name="mSpeed"> moving speed </param>
        ...
        public static void JogStop(int iAxis)
        {
        ...
        public static int CheckAxisState(int iAxis)
        {
            short pStsWord = 0;
        ...
        public static void ReleaseLimit(int iAxis, int iDirection)
        {
            if (iDirection == 0)
        ...
        /// <param name="iAxis"> axis number </param>
        /// <param name="iDirection"> 0: positive; 1: negative; 2: both; </param>
        public static void SetLimit(int iAxis, int iDirection)
        {
            if (iDirection == 0)
                NMC_MtSetLmtCfg(axisHandle[iAxis], 1, 0, 0, 0);
            else if (iDirection == 1)
        ...
        /// <summary>
        /// Output analog voltage to the given port.
        /// with percentage to the maximum voltage
        /// </summary>
        /// <param name="port"> IO port </param>
        /// <param name="percentage"> voltage percentage </param>
        public static void SetVoltage(int port, double volpercentage)
        {
            short icode = (short)(VOLT_BASE + volpercentage * VOLTAGE_CODE);
            NMC_SetDac(devHandle, (short)port, icode);
        }
        ...
        /// <param name="WeldSpeed"> moving speed </param>
        /// <param name="synAcc"> synthesis acceleration </param>
        public static void CircleMove(List<int[]> ptsList, List<double> WeldSpeed, double synAcc = 0.5, int startSeg = 0)
        {
            ClearBuffer();
        ...
        public static void LineMove(List<int[]> ptsList, List<double> WeldSpeed, double synAcc = 0.5, int startSeg = 0)
        {
            ClearBuffer();
            for (int i = 0; i < ptsList.Count; i++)
            {
                int[] rpts = new int[3] { ptsList[i][0], ptsList[i][1], ptsList[i][2] };
                NMC_CrdLineXYZEx(pcrdHandle, i + startSeg, 0x07, rpts, 0, WeldSpeed[i], synAcc, 0);
            }
        ...
        /// <param name="synAcc"></param>
        public virtual void RotateMove(List<int[]> pts, List<double> Speed, double synAcc = 0.5, int startSeg = 0)
        {
            ClearBuffer();
        ...
        /// <summary>
        /// Check axes state in moving process.
        /// </summary>
        /// <returns> false: axis is busy </returns>
        protected static bool CheckAxesMove()
        {
            short crdState = 0;
            while (true)
            {
                ...
                if ((crdState & BIT_AXIS_BUSY) == 0) return false;
                else
                {
        ...
        /// <summary>
        /// Start to move along the coordinate axis.
        /// </summary>
        protected static void MoveCoordinateAxis()
        {
        ...
        /// </summary>
        public virtual void ReadCoordinate(out int[] pos)
        {
            int[] retin = new int[4];
            for (short i = 0; i < 4; i++)
        ...
        public static int ReadAxisCoordinate(int axisNum)
        {
            int ret = 0;
