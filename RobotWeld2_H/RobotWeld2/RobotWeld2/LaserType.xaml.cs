...
namespace RobotWeld2
{
    ...
    public partial class LaserType : Window
    {
        ...
        public LaserType(WorkPackage workPackage)
        {
            viewModel = new LaserTypeViewModel();
            this.workPackage = workPackage;
            viewModel.MaxLaserPower = workPackage.GetMaxPower();

            InitializeComponent();
            this.DataContext = viewModel;
        }

        public LaserType(DaemonFile daemonFile)
        {
            viewModel = new LaserTypeViewModel();
            this.daemonFile = daemonFile;
            viewModel.MaxLaserPower = daemonFile.MaxPower;
        ...
        private void OkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            workPackage?.SetMaxPower(viewModel.MaxLaserPower);
            Close();
        }
