...
namespace RobotWeld2
{
    ...
    public partial class SelectMaterial : Window
    {
        ...
        public SelectMaterial(WorkPackage workPackage)
        {
            viewModel = new SelectViewModel();
            this.workPackage = workPackage;
            InitializeComponent();

            viewModel.MaterialName = workPackage.MetalMaterial.MaterialName;
            viewModel.SheetThickness = workPackage.MetalMaterial.Thickness;
            viewModel.WireDiameter = workPackage.MetalMaterial.WireDiameter;
...
/*            viewModel.MaterialIndex = daemonFile.MaterialIndex;
        ...
        private void OkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (workPackage != null)
            {
                workPackage.MetalMaterial.MaterialName = viewModel.MaterialName;
                workPackage.MetalMaterial.Thickness = viewModel.SheetThickness;
                workPackage.MetalMaterial.WireDiameter = viewModel.WireDiameter;
            }
