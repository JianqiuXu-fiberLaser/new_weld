...
namespace RobotWeld2
{
    ...
    public partial class ManualOperation : UserControl
    {
        ...
        private void LeftEnter_Click(object sender, RoutedEventArgs e)
        {
            manualOperationModel.LeftEnter();
        }

        private void RightEnter_Click(object sender, RoutedEventArgs e)
        {
            manualOperationModel.RightEnter();
        }
    }
}
