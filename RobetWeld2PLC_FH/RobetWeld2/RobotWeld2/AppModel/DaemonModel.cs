...
namespace RobotWeld2.AppModel
{
    public class DaemonModel
    {
        ...
        public const double VaneRadius = 23 * MM;
        public const double Rise = 100;
        public const double Fall = 100;
        ...
        {
            int pid = _mainViewModel.PtIndex;
            _isChanged = true;
            _dmFile.AddPoint(_mainViewModel.X, _mainViewModel.Y, _mainViewModel.Z);
            _mainViewModel.PtIndex = pid;
        }

        /// <summary>
        /// Automatically calculate points matched to the existing trace
        /// </summary>
