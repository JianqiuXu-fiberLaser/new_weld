...
namespace RobotWeld2.AlgorithmsBase
{
    ...
    public class ExtraController
    {
        ...
        private readonly PlcIoViewModel? plcViewModel;
        public AirValveViewModel? airValveViewModel;
        private readonly ManualOperationViewModel? manualViewModel;
        ...
        /// </summary>
        /// <param name="mty"> memory type: HD or D </param>
        /// <param name="addr"> the address </param>
        /// <returns> the data </returns>
        public int ReceiveFromPLC(MemType mty, int addr)
        {
            var ret = plc?.ReceiveFromPLC((MemType)mty, addr);
            if (!ret.HasValue) return 0;
        ...
        /// <summary>
        /// Turn on the M-type address, and reset it after 2000 ms 
        /// </summary>
    ...
    public class ChkPre : ExtraController
    {
        ...
        public void CheckPstate()
        {
            while (true)
            {
                ...
                Thread.Sleep(20);
                if (GetState(ActionIndex.RIGHT_READY_STATE))
                {
    ...
    public enum ActionIndex
    {
        ...
        LEFT_WELD_STATE = 1353,
        RIGHT_WELD_STATE = 1383,
        LEFT_ORG_STATE = 1352,
        RIGHT_ORG_STATE = 1382
    }
