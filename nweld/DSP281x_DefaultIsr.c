...
// INT6.1
interrupt void SPIRXINTA_ISR(void)    // SPI-A//ÔÝÊ±×¢ÊÍµô
{
  // Insert ISR Code here
...
// INT9.1
/* re-defined in main.c, Xu 20210423
...
//------------------------------------------------------------
// This Interrupt is modified un-reasonable,
// because most of case we do not use Transmit interrupt
// Note: can not active PIE9.INTx2
// xu 20210515
//-------------------------------------------------------------
// INT9.2
interrupt void SCITXINTA_ISR(void)  //Hua Add
{
    //PieCtrlRegs.PIEACK.bit.ACK9 = 1;                // response to interrupt
    ;
}
